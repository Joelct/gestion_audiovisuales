...
function EquiposForm() {
  const { createEquipo, editarEquipo, getEquipo } = useEquipos();
  ...
  const initialValues = {
    ...
    descripcion_marcas: '',
    descripcion_modelo: '',
    tec_conexion_descripcion: '',
    estado_equipos: ''
  };

  const validationSchema = Yup.object({
    idequipos: Yup.number(),
    descripcion_equipos: Yup.string().required('La descripción del equipo es requerida'),
    ...
    tec_conexion_descripcion: Yup.string().required('La descripción de la conexión técnica es requerida'),
    estado_equipos: Yup.string().required('El estado del equipo es requerido')
  });

  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      if (params.id) {
        await editarEquipo(params.id, values);
      } else {
      ...
      >
        {({ isSubmitting }) => (
          <Form className="space-y-6">
            ...
            <div>
              <label htmlFor="descripcion_equipos" className="block text-sm font-medium text-gray-300">Descripción del Equipo</label>
              <Field type="text" name="descripcion_equipos" className="mt-1 block w-full p-2.5 bg-gray-700 text-white rounded-md" />
              <ErrorMessage name="descripcion_equipos" component="div" className="text-red-500 text-sm mt-1" />
            </div>
            <div>
            ...
            <div>
              <label htmlFor="tec_conexion_descripcion" className="block text-sm font-medium text-gray-300">Descripción de la Conexión Técnica</label>
              <Field type="text" name="tec_conexion_descripcion" className="mt-1 block w-full p-2.5 bg-gray-700 text-white rounded-md" />
              <ErrorMessage name="tec_conexion_descripcion" component="div" className="text-red-500 text-sm mt-1" />
            </div>
            <div>
              <label htmlFor="estado_equipos" className="block text-sm font-medium text-gray-300">Estado del Equipo</label>
              <Field as="select" name="estado_equipos" className="mt-1 block w-full p-2.5 bg-gray-700 text-white rounded-md">
              ...
              <ErrorMessage name="estado_equipos" component="div" className="text-red-500 text-sm mt-1" />
            </div>
