        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {equipos.map((equipo) => (
            <div key={equipo.idequipos} className="bg-gray-800 p-6 rounded-lg shadow-md">
              <h2 className="font-bold text-white mb-2">ID: {equipo.idequipos}</h2>
              <h3 className="text-xl font-bold text-white mb-2">Descripción: {equipo.descripcion_equipos}</h3>
              ...
              <p className="text-gray-400 mb-2">Descripción Marca: {equipo.descripcion_marcas}</p>
              <p className="text-gray-400 mb-2">Descripción Modelo: {equipo.descripcion_modelo}</p>
              <p className="text-gray-400 mb-2">Tecnología Conexión: {equipo.tec_conexion_descripcion}</p>
